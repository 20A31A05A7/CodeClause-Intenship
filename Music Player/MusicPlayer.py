...
#right Frame
listbox=Listbox(right_frame,selectmode=SINGLE,width=25,height=9,bg=c02,fg=c01,font='Arial 9 bold')
...
play_button=Button(down_frame,width=30,height=30,image=img_2,padx=10,font=('Ivy 10'),command=play_music)
play_button.place(x=25+35,y=35)

img_3= Image.open('Icons/rewind.png')
img_3=img_3.resize((30,30))
img_3= ImageTk.PhotoImage(img_3)
prev_button=Button(down_frame,width=30,height=30,image=img_3,padx=10,font=('Ivy 10'),command=prev_music)
prev_button.place(x=25,y=35)

img_4= Image.open('Icons/fastforward.png')
img_4=img_4.resize((30,30))
img_4= ImageTk.PhotoImage(img_4)
forward_button=Button(down_frame,width=30,height=30,image=img_4,padx=10,font=('Ivy 10'),command=next_music)
forward_button.place(x=60+35,y=35)

img_5= Image.open('Icons/pause.png')
img_5=img_5.resize((30,30))
img_5= ImageTk.PhotoImage(img_5)
forward_button=Button(down_frame,width=30,height=30,image=img_5,padx=10,font=('Ivy 10'),command=pause_music)
forward_button.place(x=95+35,y=35)

img_6= Image.open('Icons/resume.png')
img_6=img_6.resize((30,30))
img_6= ImageTk.PhotoImage(img_6)
forward_button=Button(down_frame,width=30,height=30,image=img_6,padx=10,font=('Ivy 10'),command=continue_music)
forward_button.place(x=130+35,y=35)

img_7= Image.open('Icons/stop.png')
img_7=img_7.resize((30,30))
img_7= ImageTk.PhotoImage(img_7)
forward_button=Button(down_frame,width=30,height=30,image=img_7,padx=10,font=('Ivy 10'),command=stop_music)
forward_button.place(x=165+35,y=35)


running_song= Label(down_frame,text='Choose a song',font=('Ivy 10'),width=44,height=1,bg='#ffffff',anchor=W)
